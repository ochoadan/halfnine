...
import { RootHero, RootStats, RootFeature, RootDevProcess, RootFeatureGrid, RootOffer, RootOffering, } from "@/components/pages/root";
...
const Page = () => (
  <>
    <RootHero />
    {[RootOffer, RootOffering, RootDevProcess, RootFeature, RootStats, RootFeatureGrid, GlobalFAQ, GlobalContactForm].map((Component, index) => (
      <div key={index} className={`bg-${index % 2 === 0 ? "gray-50" : "white"} py-16 md:py-32`}>
