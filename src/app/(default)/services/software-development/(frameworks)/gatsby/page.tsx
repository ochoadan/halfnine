...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.halfnine.com/services/software-development/gatsby",
  },
};
  ...
  return (
    <>
      <TechnologyInfo
        ...
        message={message}
        imgSrc="/img/services/gatsby.svg"
      />
      ...
      <SolutionBaseListOnce
        ...
        description="The Gatsby Ecosystem is richly endowed with features and tools that cater specifically to the needs of frontend developers. At its core, Gatsby leverages the power of React and GraphQL, making it a familiar environment for developers skilled in these technologies. This foundation simplifies the transition to Gatsby, allowing for quick customization and efficient development of web pages."
        features={dataV3}
      />
