...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.halfnine.com/services/software-development/spring",
  },
};
  ...
  return (
    <>
      <TechnologyInfo
        ...
        message={message}
        imgSrc="/img/services/spring.svg"
      />
      ...
      <SolutionBaseListOnce
        ...
        description="Spring Boot stands as a pivotal element within the broader Spring Framework, designed to enhance and simplify the development of new applications. It is particularly noted for its ability to support rapid application development through a range of sophisticated features and tools."
        features={dataV3}
      />
