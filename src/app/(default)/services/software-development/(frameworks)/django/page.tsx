...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.halfnine.com/services/software-development/django",
  },
};
  ...
  return (
    <>
      <TechnologyInfo
        ...
        message={message}
        imgSrc="/img/services/django.svg"
      />
      <SolutionCheckListEven
        background="dark"
        heading={`Benefits of Custom ${technology} Solutions`}
        description={`Django's architecture promotes the "Don't Repeat Yourself" (DRY) principle, enhancing the efficiency of development cycles by reducing redundancy and promoting code reusability. This approach not only accelerates the development process but also ensures a higher level of code quality and maintainability.`}
        features={dataV1}
      />
