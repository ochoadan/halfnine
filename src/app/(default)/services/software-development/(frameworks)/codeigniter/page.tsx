...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.halfnine.com/services/software-development/codeigniter",
  },
};
  ...
  return (
    <>
      <TechnologyInfo
        ...
        message={message}
        imgSrc="/img/services/codeigniter.svg"
      />
      ...
      <SolutionBaseListOnce
        ...
        description="The CodeIgniter ecosystem thrives due to its robust, open-source framework, governed under the MIT license, which encourages widespread usage and contribution. Its lightweight nature is a significant advantage, requiring minimal resources while allowing for dynamic library loading based on specific needs. This ensures that CodeIgniter applications are both fast and efficient, fostering a quicker deployment process."
        features={dataV3}
      />
