...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.halfnine.com/services/software-development/remix",
  },
};
  ...
  return (
    <>
      <TechnologyInfo
        ...
        message={message}
        imgSrc="/img/services/remix.svg"
      />
      <SolutionCheckListEven
        background="dark"
        heading={`Benefits of Custom ${technology} Solutions`}
        description="Custom Remix solutions offer a myriad of benefits tailored to enhance business operations and user experience. Here are some prominent advantages:"
        features={dataV1}
      />
