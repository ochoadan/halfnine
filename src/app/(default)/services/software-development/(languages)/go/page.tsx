...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.halfnine.com/services/software-development/go",
  },
};
  ...
  return (
    <>
      <TechnologyInfo
        ...
        message={message}
        imgSrc="/img/services/go.svg"
      />
      <SolutionCheckListEven
        background="dark"
        heading={`Benefits of Custom ${technology} Solutions`}
        description="Custom software development, particularly using Go, offers a multitude of benefits tailored to meet specific business needs. These advantages ensure that organizations not only keep pace with market demands but also excel in their operational capabilities."
        features={dataV1}
      />
