...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.halfnine.com/services/software-development/shell",
  },
};
  ...
  return (
    <>
      ...
      <SolutionBaseListOnce
        ...
        description="Shell, a global leader in energy system sectors, plays a pivotal role in shaping the future of energy. Engaged in diverse areas such as Upstream, Liquified Natural Gas, and Gas to Liquids Technology, Shell is at the forefront of driving innovation across the energy landscape. The company’s commitment extends into Energy and Chemicals parks and the burgeoning New Energies sector, focusing on renewable power generation."
        features={dataV3}
      />
