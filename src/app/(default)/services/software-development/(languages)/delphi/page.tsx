...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.halfnine.com/services/software-development/delphi",
  },
};
  ...
  return (
    <>
      <TechnologyInfo
        ...
        message={message}
        imgSrc="/img/services/delphi.svg"
      />
      <SolutionCheckListEven
        background="dark"
        heading={`Benefits of Custom ${technology} Solutions`}
        description="Custom Delphi solutions offer a multitude of benefits, making them a preferred choice for diverse industries ranging from healthcare to finance. Here are some key advantages:"
        features={dataV1}
      />
      ...
      <SolutionBaseListOnce
        ...
        description="Delphi is a robust, general-purpose programming language that facilitates the rapid application development (RAD) of desktop, mobile, web, and console software. It supports native code generation across diverse platforms including Microsoft Windows, macOS, iOS, Android, and Linux (x64), making it a versatile tool for developers."
        features={dataV3}
      />
