...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.halfnine.com/services/software-development/typescript",
  },
};
  ...
  return (
    <>
      <TechnologyInfo
        ...
        message={message}
        imgSrc="/img/services/typescript.svg"
      />
      <SolutionCheckListEven
        background="dark"
        heading={`Benefits of Custom ${technology} Solutions`}
        description="TypeScript, as a superset of JavaScript, introduces several advantages that significantly enhance software development processes and outcomes. Here are the key benefits:"
        features={dataV1}
      />
