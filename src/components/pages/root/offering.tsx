...
export default function RootOffering() {
  return (
    <div className="bg-gray-50 pb-16 pt-24 sm:pb-24 sm:pt-32 xl:pb-32">
      <div className="bg-gray-900 pb-20 sm:pb-24 xl:pb-0">
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
          <div className="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
            <div className="relative aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
              <Image
                className="absolute inset-0 h-full w-full xl:max-w-sm rounded-2xl bg-gray-800 object-cover shadow-2xl"
...
Complete management and support of your cloud or on-premises IT
environment
</p>
...
<ul
role="list"
className="mt-4 grid grid-cols-1 gap-x-8 gap-y-3 text-base leading-7 sm:grid-cols-2"
>
<li className="flex gap-x-3">
<CheckCircleIcon className="h-7 w-5 flex-none text-sky-600" />
{"feature.name"}
</li>
<li className="flex gap-x-3">
<CheckCircleIcon className="h-7 w-5 flex-none text-sky-600" />
...
<FadeIn className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg bg-gray-100 lg:col-span-2">
<Image
